...
#' Low value color
#'
#' A variable containing a BAS Consultancy company color used for the lowest value in positive
...
#' High value color
#'
#' A variable containing a BAS Consultancy company color used for the highest value in positive
#' valued gradients. The color value is in hexadecimal format.
#'
"col_bas_high"
